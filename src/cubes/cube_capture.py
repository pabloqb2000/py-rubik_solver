...
class CubeCapture:
    ...
    def __init__(self, cube_robot, video_capture=0):
        ...
        self.vc = video_capture
    

    def __detect_face__(self, frame, positions, r=detection_radius_def):
        """
    ...
    def __take_pictures__(self, camera, positions):
        """
        ...
        while True:
            ...
            if k == 27:
                ...
                # SPACE pressed
                colors = self.__detect_face__(frame, positions)
    ...
    def capture_cube(self):
        ...
        # Show point clusters
        self.__plot_3d_scatter_plot__(all_colors)
        ...
        face_values, mean_colors = self.k_means(all_colors)
